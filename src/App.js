 ...
 const myIP = (location) => {
  ...
  return (
    <div className="bg-gray-800 flex items-center justify-center w-screen h-screen py-10">
       <div className="flex w-2/4 min-h-full rounded-3xl shadow-lg m-auto bg-gray-100">
         {/* form section */}
         <div className="form-container">
           ...
           <div className="flex flex-col items-center justify-center h-full">
            ...
            <form noValidate onSubmit={handleSubmit} className="flex justify-center w-full">
                <input 
                className="relative rounded-xl py-2 px-3 ml-5 w-2/3 bg-gray-300 bg-opacity-60 text-white placeholder-gray-200"
                type="text"
                ...
                <div className="w-2/4 p-5">
                  ...
                  ">
                      ...
                      <div className="container p-4 flex items-center h-1/3 mb-auto">
                      <h1 className="text-gray-300 text-4xl font-bold uppercase">
                        {noData}
                      </h1>
                      </div>: <>
                          <h1 className="text-5xl text-gray-800 mt-auto
                          mb-4
                          ">
                            <DetailCard
